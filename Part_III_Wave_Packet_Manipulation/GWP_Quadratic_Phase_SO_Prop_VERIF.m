...
phase_coeff = [0, time_delay/2]; % Define the coefficients of the components of the polynomial phase term (no constant term included)
...
hold on
real_wavefunction_analytical = plot(x, real(psi_analytical_t(:, 1)), 'LineWidth', 2); % Plot the imaginary wavefunction
hold off
...
%     end
% 
%     pause(5); % Pause to create an animation effect
