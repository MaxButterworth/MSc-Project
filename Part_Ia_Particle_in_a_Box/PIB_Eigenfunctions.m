...
N = 1000; % Number of discretisation points
N_eigenvectors = 100; % Number of eigenvectors of H to calcualte

% ======================================================================================================================================
%%%%% Discretise the spatial domain, x %%%%%
% ======================================================================================================================================

x = linspace(0, L, N); % Define the domain of the infinite potential well
