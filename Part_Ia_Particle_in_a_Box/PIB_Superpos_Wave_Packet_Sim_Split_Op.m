...
basis_funcs_indices = [3]; % Create an array of the indices of PIB_eigenstates_norm that form the superposition
...
V_vector = zeros(N_steps, 1); % Define the potential energy vector for a QHO
...
% ======================================================================================================================================
%%%%%%%%%% Generate an initial wave packet composed of a superposition of PIB eigenfunctions %%%%%%%%%%
% ======================================================================================================================================
...
psi0_norm = psi0/sqrt(trapz(x, abs(psi0).^2)); % Normalise the initial wave packet
