...
% Plot densities
plots.density           = vis.surface;   % Iso-surface representation
plots.density.srf_view  = [63 42];       % Viewing angle [az el]
...
plots.density.srf_nlev  = [3 3];         % Number of iso-surfaces: density|energy
plots.density.srf_color = [true true];   % Toggle manual settings of iso-levels 
plots.density.col_min   = [0.005 0.1];   % Lowest iso-level for density plots
plots.density.col_max   = [0.025 0.3];   % Highest iso-level for density plots
