...
global hamilt plots space state time control reduce
...
time.rho.temperature = 1.0;              % choice of temperature
...
elseif strcmpi(class(state),'rho')
    ...
    plots.expect.y_min = 0.26;           % Range of population plot
    plots.expect.y_max = 0.42;           % Range of population plot
end