...
% plots.density.energy    = true;          % Plot also the energy surface
% plots.density.srf_color = false;         % Toggle manual settings of iso-levels 
% plots.density.col_map   = 'cool';        % Choice of color map
