...
prt.disp ( 'Laser pulse optimized for 1-photon transition: 0->1 ' )
prt.disp ( '                                                    ' )
prt.disp ( 'see M.V.Korolkov, G.K.Paramonov, and B. Schmidt     ' )
prt.disp ( 'J. Chem. Phys. 105(5), 1862-1879  (1996)            ' )
prt.disp ( 'see W. Zhu, J. Botina, H. Rabitz                    ' )
prt.disp ( 'J. Chem. Phys. 108(5), 1953-1963  (1998)            ' )
prt.disp ( '*****************************************************************' )
...
time.rho.pure = 0;                       % vibrational ground state
