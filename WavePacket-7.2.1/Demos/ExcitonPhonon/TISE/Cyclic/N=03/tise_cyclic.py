...
def coupled_tise(batch_mode):
    ...
    dynamics = TISE(
        ...
        n_levels=6,                      # number of energy levels to be calculated
        ...
        e_est=0.0817,                    # estimation: eigenvalues closest to this number
        e_min=0.081,                     # lower end of energy plot axis (if exact energies not available!)
    ...
    # Interactive mode: Setup animated visualization
        ...
        graphics = VisualTISE(
            ...
            plot_type='QuantNumbers2',   # select your favorite plot type
