...
classdef interp < efi.generic & handle
    ...
    methods (Access = public)
       ...
       % Constructor: from superclass
        ...
        % Initialization: Read tabulated pulse and preprocess
        function init ( obj )

            % Read times and fields
            fid = fopen(obj.file);
            if fid == -1
            ...
            % Extract times and fields from Nx2 array
            obj.times = data(:, 1);
            obj.fields = data(:, 2);
            ...
            % Call initialization of superclass
