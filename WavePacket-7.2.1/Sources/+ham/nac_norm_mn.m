...
function nac_norm_mn = nac_norm_mn (pot_mats,frc_mats,U,D,m,n)
global space hamilt
...
if n_traj>0
    ...
    nac_norm_mn = cell(space.n_dim,1);
    
    switch hamilt.coupling.n_eqs
        case 1
            for d=1:space.n_dim
                nac_norm_mn{d} = zeros(n_traj,1);
            end
        case 2
