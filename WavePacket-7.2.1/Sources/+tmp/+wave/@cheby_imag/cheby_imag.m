...
classdef cheby_imag < handle
    ...
    properties (Access = public)
        ...
        threshold       % used for detection of convergence (in imag. time)
    end
    ...
    methods (Access = public)
        ...
        function obj = cheby_imag(my_ord, my_prec, my_thresh)
            ...
            if isempty (my_thresh)
                obj.threshold = sqrt(eps);
            else
                obj.threshold = my_thresh;
            end
        ...
        function disp(obj)
            ...
            prt.disp (['Threshold for convergence in imag. time : ' num2str(obj.threshold)])          
        end
