...
classdef surface < vis.densities & handle
    ...
    properties (Access = public)
        ...
        col_map     % Choice of one of Matlab's color maps
        
        % For 3D iso-surface plots only
        srf_nlev    % Number of iso-surfaces
        srf_maps    % Choice of color maps or default colors
    ...
    methods (Access = public)
        ...
        function obj = surface
            ...
            % For 3D iso-surface plots only
            obj.srf_nlev = [5 3];        % Number of iso-surfaces: density|energy
            obj.srf_maps = [false false];% Choice of color maps or default colors
        end
    ...
    methods (Static)
        cmap = get_colormap (Choice,Length)
    end
