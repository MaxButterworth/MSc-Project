...
%
% This function also provides numerical conversion factors between
...
switch lower(string1)
    ...
    case 'fssh_2'    % fewest switches surface hopping 2
        if nargin==1
            param1=[];                   % number of trajectories
            param2=[];                   % seeding random number generator
        elseif nargin==2
        ...
        state = sht.fssh_2(param1,param2);
        
    case 'fssh_3'     % fewest switches surface hopping 3
        if nargin==1
            param1=[];                   % number of trajectories
            param2=[];                   % seeding random number generator
        elseif nargin==2
        ...
        state = sht.fssh_3(param1,param2);
        
    case 'fssh_4'     % fewest switches surface hopping 4
        if nargin==1
            param1=[];                   % number of trajectories
            param2=[];                   % seeding random number generator
        elseif nargin==2
        ...
        state = sht.fssh_4(param1,param2);
        
    case 'fssh_sa'     % fewest switches surface hopping using the super adiabatic representation
        if nargin==1
            param1=[];                   % number of trajectories
            param2=[];                   % seeding random number generator
        elseif nargin==2
        ...
        state = sht.fssh_sa(param1,param2);
        
    case 'fssh_i'     % fewest switches surface hopping with cumulative probabilities
        if nargin==1
            param1=[];                   % number of trajectories
            param2=[];                   % seeding random number generator
        elseif nargin==2
        ...
        state = sht.fssh_i(param1,param2);
        
    case 'qtsh'     % quantum trajectory surface hopping
        if nargin==1
            param1=[];                   % number of trajectories
            param2=[];                   % seeding random number generator
        elseif nargin==2
    ...
    case {'sssh_nac','lz_nac'}           % single switch surface hopping with maximal NAC criterion
        if nargin==1
            param1=[];                   % LZ variant
            param2=[];                   % number of trajectories
            param3=[];                   % seeding random number generator
        ...
        state = sht.sssh_nac(param1,param2,param3);
    ...
    case {'sssh_gd_mc','lz_gd_mc'}       % single switch surface hopping multiple channels, for special handling of more than 2 electronic states
        if nargin==1
            param1=[];                   % number of trajectories
            param2=[];                   % seeding random number generator
        elseif nargin==2
