...
classdef generic < handle
    ...
    properties (Access = public) 
        ...
        empty       % Is this polarizability empty?

    end
    
    methods (Access = public)
        
        % Constructor: Set empty polarizability as the default
        ...
        function disp (obj)
            ...
            prt.disp('***************************************************************')
            if obj.row == obj.col
                prt.disp([ int2str(obj.p_1) '-' int2str(obj.p_2) '-th component of polarizability for channel ' hamilt.coupling.labels{obj.row} ':'])
            else
