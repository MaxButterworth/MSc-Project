...
classdef traj < generic & handle
    ...
    properties (Access = public)
        ...
        u_sa        % Superadiabatic states (eigenvectors)
        u_sa_old    % Superadiabatic states (eigenvectors) of the previous step

        ens_cont    % Ensure continuity of eigenstates
        ...
        tdse_solver % choice of tdse integrator
    ...
    methods (Access = public)
        ...
        function obj = traj (n,seed)
            ...
            obj.tdse_solver = 1;
            obj.ens_cont = 0;               % Not ensuring continuity of eigenstates
        ...
        psi = tdse_adi (obj, step_size, D, obj_U_new, obj_U_old, psi_old)
        psi = tdse_dia (obj, step_size, pos, psi_old, psi_oldold)
        psi = tdse_dia_2 (obj, step_size, pos, psi_old, psi_oldold)
        psi = tdse_adi_euler (obj, step_size, mom, pot_mats, frc_mats, D, U, psi_old, psi_oldold)
        psi = tdse_adi_trapezoidal (obj, step_size, mom, pot_mats, frc_mats, D, U, mom_old, pot_mats_old, frc_mats_old, D_old, U_old, psi_old, psi_oldold)
    end
