...
% Comment/uncomment these two lines before/after each release of a new version
% info.version1 = 'V7.2.0';
% info.version2 = 'V7.2.0';
...
% Availability of "Control System Toolbox"
if strcmpi(info.system,'Matlab')
    addons = matlab.addons.installedAddons;
    info.control_system = ...
        any(strcmpi(addons.Name,"Control System Toolbox"));
elseif strcmpi(info.system,'Octave')
    info.control_system = true; % loaded in qm_setup.m 
end
...
prt.disp (['Control system toolbox : ', int2str(info.control_system)])
prt.disp ( ' ' )
...
prt.disp ( ' ' )
prt.disp ( ' (C) 2004-2024 Burkhard Schmidt, Ulf Lorenz, FU Berlin' )
