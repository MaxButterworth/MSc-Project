...
% Modification by Mats Simmermacher (19/01/2018)
%    changed: psi.dvr.grid_ND = wavefunc{1};
%    to: psi.dvr.grid_ND{1} = wavefunc{1};
%    This prevents the definition of "psi.dvr.grid_ND" as a simple array
%    that, when addressed by "psi.dvr.grid_ND{m} below, would give the
%    error "Cell contents reference from a non-cell array object".
%    "psi.dvr.grid_ND" has to be a cell object.
        psi.dvr.grid_ND{1} = wavefunc{1};
